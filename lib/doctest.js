...
(function() {
  var CoffeeScript, commonjsEval, doctest, esprima, fetch, fs, functionEval, log, noop, pathlib, repr, rewrite, run, substring, toModule, transformComments, validators, _,
    __slice = [].slice;
